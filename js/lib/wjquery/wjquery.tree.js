...
(function ($) {
                ...
                if ($t.find("i." + WTREE_CODE.icon.plus).length == 1) {
                    ...
                    */
                    ...
                    $p.find("i." + WTREE_CODE.icon.minus).each(function () {
                        ...
                        $(this).siblings(".opened").changeClass(WTREE_CODE.icon.opened, WTREE_CODE.icon.closed);
    ...
    var _WTREE = {
        draw: function ($element, options, nodeId, data) {
            ...
            if ($c.children("ul").isObject()) {} else {
                ...
                $.each(nodes, function () {
                    sb.append("<li data-type=\"" + WTREE_CODE.type.node + "\" data-id=\"" + this.nodeId + "\"><a href=\"javascript:void(0);\" class=\"item\"><i class=\"" + (this.hasChildren ? WTREE_CODE.icon.plus : WTREE_CODE.icon.empty) + "\"></i><i class=\"" + WTREE_CODE.icon.closed + "\"></i><span>" + this.nodeId + "</span></a></li>");
                });
